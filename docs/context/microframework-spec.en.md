...
| Execute Workflow assigns dynamic IDs on each installation | Orchestrators need manual ID updates after import | Import protocol documented in `docs/protocolo-evidencias.md` §3 |
