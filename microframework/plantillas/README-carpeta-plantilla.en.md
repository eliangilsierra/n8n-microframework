...
| **E — Rules/patterns/conventions folder** | `microframework/` (root), `microframework/checklists/`, `microframework/convenciones/`, `microframework/patrones/`, `microframework/plantillas/`, `microframework/reglas/`, `docs/context/` | Table mapping the content to `REG-*`/`REC-*` IDs or pattern names; one paragraph explaining why this folder exists within the micro-framework (which Clean Architecture or DevSecOps pillar it supports) |
