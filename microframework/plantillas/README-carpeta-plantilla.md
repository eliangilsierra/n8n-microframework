...
| **E — Carpeta de reglas/patrones/convenciones** | `microframework/` (raíz), `microframework/checklists/`, `microframework/convenciones/`, `microframework/patrones/`, `microframework/plantillas/`, `microframework/reglas/` | Tabla que mapea el contenido a IDs `REG-*`/`REC-*`/nombre de patrón; un párrafo explicando por qué existe esta carpeta dentro del micro-framework (qué pilar de Clean Architecture o DevSecOps sustenta) |
