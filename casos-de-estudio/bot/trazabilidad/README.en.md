...
# trazabilidad/ — Bot case traceability matrix

**Path:** `casos-de-estudio/bot/trazabilidad/`
...
This folder contains the Bot case's **traceability matrix**: the complete chain
connecting functional requirements (RF-BOT-01..08) to the architectural decisions (ADR)
...
requirement to its ADR, its verifiable REG-* rule, the node or stage where it's
implemented, the Input Set that exercises it, and the evidence file (run-log/cr-log)
backing it. It is the same traceability chain described in
[`microframework/microframework-spec.md`](../../../microframework/microframework-spec.en.md)
applied end to end to the Bot case.

## Navigation

- Parent: [`casos-de-estudio/bot/`](../README.en.md)
- See also: [`casos-de-estudio/bot/adr/`](../adr/README.en.md) · [`casos-de-estudio/iot/trazabilidad/`](../../iot/trazabilidad/README.en.md) (equivalent IoT matrix)
