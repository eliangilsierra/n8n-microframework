...
| Artefacto | Propósito | Estado |
|---|---|---|
| `atam/analisis-approaches.md` | 12 approaches arquitectónicos + clasificación SP/TP/R/NR × 12 escenarios | ✅ |
| `atam/matriz-scoring.md` | Scoring 1–5 as-is vs to-be por escenario con justificación y evidencia | ✅ |
| `atam/registro-riesgos-tradeoffs.md` | Registro consolidado: 3 SP · 3 TP · 4 R · 5 NR | ✅ |
...
| `atam/metodologia-atam-adaptada.md` | Marco ATAM adaptado — justificación, mapeo paso a paso, mitigación de sesgos | ✅ |
...
| Artefacto | Propósito | Estado |
|---|---|---|
| `atam/protocolo-encuesta.md` | Protocolo: criterios, consentimiento, tamaño muestral, plataforma | ✅ |
| `atam/instrumento-encuesta.md` | Encuesta completa: 18 preguntas (Sección A–E) + mini-ATAM opcional | ✅ |
| `atam/plan-analisis-encuesta.md` | Plan estadístico: descriptiva, Cronbach α, codificación abierta, κ | ✅ |
| `atam/plan-difusion.md` | Canales de difusión, plantillas de invitación, lista de candidatos | ✅ |
| `atam/material-apoyo/resumen-proyecto.md` | Fuente Markdown del PDF de 4 páginas para respondentes | ✅ |
| `atam/material-apoyo/guion-video.md` | Guion del video de 5 minutos para respondentes | ✅ |
| `atam/material-apoyo/diagrama-comparativo.md` | Diagramas Mermaid as-is vs to-be para PDF y diapositivas | ✅ |
| `atam/material-apoyo/README.md` | Índice de URLs públicas — PDF, video, formulario | ✅ |
| `atam/material-apoyo/guia-referencia-tecnica.md` | Transcripción de la guía de referencia técnica entregada al panel | ✅ |
...
| Artefacto | Propósito | Estado |
|---|---|---|
| `atam/informe-atam-final.md` | Capítulo de tesis R4 — 10 secciones completas, §8 con resultados reales de la encuesta | ✅ |
...
| Artefacto | Propósito | Estado |
|---|---|---|
| `atam/INDEX.md` | Este archivo — índice de todos los artefactos de Fase 7 | ✅ |
...
> junto a los demás artefactos de Fase 7 por ser su insumo directo — no en una carpeta de contexto aparte.
